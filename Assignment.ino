...
const char* ssid     = "TECNO pop7";
const char* password = "adocus562";
      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<!DOCTYPE html><html><head><title>Docus Systems Lighting</title>");
            client.println("<style>");
            client.println("body{font-family:'Segoe UI',sans-serif;background:#1e1e2f;color:white;text-align:center;padding:30px;}");
            ...
            client.println("<h1>Docus Systems</h1>");
            ...
            client.println("</div>");
            client.println("<footer>&copy; 2025 Docus Systems | Team Innovators</footer>");
